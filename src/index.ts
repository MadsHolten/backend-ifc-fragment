...
export async function ConvertIfcToFragmentsBinary(buffer: Buffer){
...
export async function ConvertIfcToFragments(ifcURL: string) {
	...
	const ifcProject = propsValues.find((prop: any) => prop.type === 103090709) as any;
	if(!ifcProject) {
